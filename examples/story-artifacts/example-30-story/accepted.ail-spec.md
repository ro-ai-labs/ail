The application Support Tickets manages customer support tickets, assignments, updates, internal notes, and overdue-ticket review.
...
- the system requires the caller role to be Customer
...
Failure PermissionDenied happens when a user tries to see internal notes without support staff permission:
