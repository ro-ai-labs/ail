...
- the system records a trace event named IncidentDeclared
...
- the system records a trace event named IncidentResponderAssigned
...
- the system records a trace event named IncidentLifecycleCompleted
...
- IncidentEscalationValidationFailed
