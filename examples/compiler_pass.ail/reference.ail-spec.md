...
- if the read target contains Secret, the system emits a diagnostic instead of
  silently adding permission
...
Failure SecretReadNeedsHumanConfirmation happens when a secret read has no
explicit human-confirmed permission:
