# support-ticket-live-codex-requirements-91 User Story
...
semantic-anchors: Support Tickets; Close ticket; TicketClosed; open ticket queue; aarch64-apple-darwin-libsystem-macho; requirements.system.md
