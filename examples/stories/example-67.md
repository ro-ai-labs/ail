# network-driver-live-codex-flow-patch-67 User Story
...
semantic-anchors: Network packet receiver; rx buffer; read network device; write rx buffer; PacketReceived; system-driver; flow-patch.system.md
