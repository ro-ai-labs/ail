# support-composed-live-codex-spec-draft-12 User Story
...
semantic-anchors: support-composed; support_shared; Shared.User; Close ticket; TicketClosed; active queue; spec-draft.system.md
