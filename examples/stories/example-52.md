# refund-tool-live-spec-input-52 User Story
...
semantic-anchors: Refund customer payment; RefundCustomerPaymentRequested; RequesterMayCreateRefunds; RefundLedger; PaymentProvider; agent-tool; spec-input
