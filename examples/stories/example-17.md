# support-composed-live-codex-flow-patch-17 User Story
...
semantic-anchors: support-composed; support_shared; Shared.User; Close ticket; TicketClosed; active queue; flow-patch.system.md
