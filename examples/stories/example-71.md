# network-driver-live-codex-requirements-71 User Story
...
semantic-anchors: Network packet receiver; rx buffer; packet metadata; network device; PacketReceived; system-driver; requirements.system.md
