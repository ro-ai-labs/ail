...
diagnostics, and repair-tutorial fingerprint reuse. Response,
...
also writes a repair tutorial that turns those diagnostics into a
corrected-spec checklist and is listed in `examples-report.txt` and
