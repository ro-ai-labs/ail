...
fn cli_ail_e2e_corpus_replays_checked_live_release_corpus() {
    ...
    assert!(
        report.contains("failure-taxonomy-count permission-capability 1"),
        "{report}"
    );
    assert!(
    ...
    assert!(
        report.contains("entry example-91")
            && report.contains("semantic-task support-ticket-live-codex-requirements-91")
            && report.contains("capture-origin live-codex"),
        "{report}"
    );
    assert!(
        report.contains("entry example-93")
            && report.contains("semantic-task support-ticket-live-codex-core-draft-93")
            && report.contains("capture-origin live-codex"),
        "{report}"
    );
    assert!(
        report.contains("entry example-94")
            && report.contains("semantic-task support-ticket-live-codex-diagnostic-repair-94")
            && report.contains("capture-origin live-codex"),
        "{report}"
    );
    assert!(
    ...
    assert!(
        report.contains("entry example-31")
            && report.contains("semantic-task support-ticket-live-codex-requirements-31")
            && report.contains("capture-origin live-codex"),
        "{report}"
    );
    assert!(
        report.contains("entry example-33")
            && report.contains("semantic-task support-ticket-live-codex-core-draft-33")
            && report.contains("capture-origin live-codex"),
        "{report}"
    );
    assert!(
        report.contains("entry example-34")
            && report.contains("semantic-task support-ticket-live-codex-diagnostic-repair-34")
            && report.contains("capture-origin live-codex"),
        "{report}"
    );
    assert!(
    ...
    assert!(
        report.contains("entry example-76")
            && report.contains("semantic-task secret-access-live-codex-core-to-summary-76")
            && report.contains("capture-origin live-codex"),
        "{report}"
    );
    assert!(
        report.contains("entry example-77")
            && report.contains("semantic-task secret-access-live-codex-flow-patch-77")
            && report.contains("capture-origin live-codex"),
        "{report}"
    );
    assert!(
        report.contains("entry example-78")
            && report.contains("semantic-task secret-access-live-codex-trace-debug-78")
            && report.contains("capture-origin live-codex"),
        "{report}"
    );
    assert!(
        report.contains("entry example-79")
            && report.contains("semantic-task secret-access-live-codex-interop-79")
            && report.contains("capture-origin live-codex"),
        "{report}"
    );
    assert!(
    ...
    assert!(
        report.contains("entry example-81")
            && report.contains("semantic-task repeated-task-live-codex-requirements-81")
            && report.contains("capture-origin live-codex"),
        "{report}"
    );
    assert!(
        report.contains("entry example-82")
            && report.contains("semantic-task repeated-task-live-codex-spec-draft-82")
            && report.contains("capture-origin live-codex"),
        "{report}"
    );
    assert!(
        report.contains("entry example-83")
            && report.contains("semantic-task repeated-task-live-codex-core-draft-83")
            && report.contains("capture-origin live-codex"),
        "{report}"
    );
    assert!(
        report.contains("entry example-84")
            && report.contains("semantic-task repeated-task-live-codex-diagnostic-repair-84")
            && report.contains("capture-origin live-codex"),
        "{report}"
    );
    assert!(
    ...
    assert!(
        report.contains("entry example-41")
            && report.contains("semantic-task refund-tool-live-codex-requirements-41")
            && report.contains("capture-origin live-codex"),
        "{report}"
    );
    assert!(
        report.contains("entry example-42")
            && report.contains("semantic-task refund-tool-live-codex-spec-draft-42")
            && report.contains("capture-origin live-codex"),
        "{report}"
    );
    assert!(
        report.contains("entry example-43")
            && report.contains("semantic-task refund-tool-live-codex-core-draft-43")
            && report.contains("capture-origin live-codex"),
        "{report}"
    );
    assert!(
    ...
    assert!(
        report.contains("entry example-97")
            && report.contains("semantic-task stateful-counter-live-codex-flow-patch-97")
            && report.contains("capture-origin live-codex"),
        "{report}"
    );
    assert!(
        report.contains("entry example-98")
            && report.contains("semantic-task stateful-counter-live-codex-trace-debug-98")
            && report.contains("capture-origin live-codex"),
        "{report}"
    );
    assert!(
    ...
    assert!(
        report.contains("entry example-3")
            && report.contains("semantic-task stdlib-collections-live-codex-core-draft-3")
            && report.contains("capture-origin live-codex"),
        "{report}"
    );
    assert!(
        report.contains("entry example-4")
            && report.contains("semantic-task stdlib-collections-live-codex-diagnostic-repair-4")
            && report.contains("capture-origin live-codex"),
        "{report}"
    );
    assert!(
        report.contains("entry example-7")
            && report.contains("semantic-task stdlib-collections-live-codex-flow-patch-7")
            && report.contains("capture-origin live-codex"),
        "{report}"
    );
    assert!(
        report.contains("entry example-8")
            && report.contains("semantic-task stdlib-collections-live-codex-trace-debug-8")
            && report.contains("capture-origin live-codex"),
        "{report}"
    );
    assert!(
    ...
    assert!(
        report.contains("entry example-13")
            && report.contains("semantic-task support-composed-live-codex-core-draft-13")
            && report.contains("capture-origin live-codex"),
        "{report}"
    );
    assert!(
        report.contains("entry example-14")
            && report.contains("semantic-task support-composed-live-codex-diagnostic-repair-14")
            && report.contains("capture-origin live-codex"),
        "{report}"
    );
    assert!(
        report.contains("entry example-15")
            && report.contains("semantic-task support-composed-live-codex-core-to-spec-15")
            && report.contains("capture-origin live-codex"),
        "{report}"
    );
    assert!(
    ...
    assert!(
        report.contains("entry example-20")
            && report.contains("semantic-task option-map-live-codex-interview-20")
            && report.contains("capture-origin live-codex"),
        "{report}"
    );
    assert!(
        report.contains("entry example-21")
            && report.contains("semantic-task option-map-live-codex-requirements-21")
            && report.contains("capture-origin live-codex"),
        "{report}"
    );
    assert!(
        report.contains("entry example-22")
            && report.contains("semantic-task option-map-live-codex-spec-draft-22")
            && report.contains("capture-origin live-codex"),
        "{report}"
    );
    assert!(
        report.contains("entry example-23")
            && report.contains("semantic-task option-map-live-codex-core-draft-23")
            && report.contains("capture-origin live-codex"),
        "{report}"
    );
    assert!(
        report.contains("entry example-24")
            && report.contains("semantic-task option-map-live-codex-diagnostic-repair-24")
            && report.contains("capture-origin live-codex"),
        "{report}"
    );
    assert!(
        report.contains("entry example-26")
            && report.contains("semantic-task c-interop-live-codex-core-to-summary-26")
            && report.contains("capture-origin live-codex"),
        "{report}"
    );
    assert!(
        report.contains("entry example-27")
            && report.contains("semantic-task c-interop-live-codex-flow-patch-27")
            && report.contains("capture-origin live-codex"),
        "{report}"
    );
    assert!(
        report.contains("entry example-28")
            && report.contains("semantic-task c-interop-live-codex-trace-debug-28")
            && report.contains("capture-origin live-codex"),
        "{report}"
    );
    assert!(
        report.contains("entry example-85")
            && report.contains("semantic-task c-interop-live-codex-core-to-spec-85")
            && report.contains("capture-origin live-codex"),
        "{report}"
    );
    assert!(
    ...
    assert!(
        report.contains("entry example-89")
            && report.contains("semantic-task c-interop-live-codex-interop-89")
            && report.contains("capture-origin live-codex"),
        "{report}"
    );
    assert!(
    ...
    assert!(
        report.contains("entry example-106")
            && report
                .contains("semantic-task network-driver-effect-without-capability-rejected-106")
    ...
    let permission_capability_diagnostics =
        fs::read_to_string(artifact_dir.join("examples/example-106/diagnostics.txt")).unwrap();
    assert!(
        permission_capability_diagnostics.contains(
            "AIL021 system component NetworkPacketReceiver performs effect 'read network device' without a declared capability"
        ),
...
fn cli_ail_e2e_corpus_replays_rejected_prompt_envelope_failures() {
    ...
    write_e2e_transcript_files(&corpus_dir, 101);
    fs::write(
        corpus_dir.join("requests").join("rejected-envelope.json"),
        r#"{"prompt":"rejected prompt envelope"}"#,
    )
    .unwrap();
    fs::write(
        corpus_dir.join("responses").join("rejected-envelope.json"),
    ...
    let diagnostics =
        fs::read_to_string(artifact_dir.join("examples/example-100/diagnostics.txt")).unwrap();
    assert!(
        diagnostics.contains("checker-result rejected")
            && diagnostics.contains("expected-diagnostic AIL-PROMPT-001")
    ...
    assert!(
        report.contains("checker-result-count accepted 100")
            && report.contains("checker-result-count rejected 1")
            && report.contains("failure-taxonomy-count prompt-envelope 1")
            && report.contains(
                "entry-artifact example-100 diagnostics examples/example-100/diagnostics.txt"
            ),
        "{report}"
    );
