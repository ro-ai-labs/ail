...
the edited node or edge. `declare_provenance` attaches reviewed provenance to
an existing node without changing semantic attributes. The patched Core can be
