...
- Counted catalog examples: 127
- Accepted prompt-to-artifact examples: 118
- Rejected diagnostic examples: 9
- Story files: 127
- Stored request transcripts: 127
- Stored response artifacts: 127
...
| `examples/ui_workflow.ail/` | `ui-workflow` | UI | 4 | UI route, form, dashboard, workflow ordering, accessibility, rejected inaccessible-error diagnostics, and Wasm target-contract evidence. |
