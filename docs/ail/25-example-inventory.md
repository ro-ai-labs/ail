...
- Counted catalog examples: 124
- Accepted prompt-to-artifact examples: 115
- Rejected diagnostic examples: 9
- Story files: 124
- Stored request transcripts: 124
- Stored response artifacts: 124
...
| `examples/incident_response.ail/` | `incident-response` | Application | 6 | High-level multi-module incident workflows, UI surfaces, target contracts, regenerated story views, and one promoted package-local repair proof. |
