...
- Counted catalog examples: 122
- Accepted prompt-to-artifact examples: 113
- Rejected diagnostic examples: 9
- Story files: 122
- Stored request transcripts: 122
- Stored response artifacts: 122
...
| `examples/recursive_factorial.ail/` | `recursive-factorial` | Application | 5 | Turing Core recursive function examples with base-case, self-call, arithmetic return, bytecode, and VM trace evidence. |
