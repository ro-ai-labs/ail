...
BASE_CHAPTERS: tuple[ManualChapter, ...] = (
    ManualChapter(
        ...
        commands=(
            ...
            ManualCommand(
                label="plan-story-promotion-batch",
                command=(
                    "python3",
                    ...
                    "/tmp/ail-manual-story-promotion-examples",
                    "--artifact-dir",
                    "/tmp/ail-manual-story-promotion-batch-plan",
                ),
                live=True,
                evidence=(
        ...
        commands=(
            ManualCommand(
                ...
                evidence=(
                    ...
                    "reviewed-pass-order-conflict AIL-BOOTSTRAP-PASS-ORDER-001",
            ...
            ManualCommand(
                label="verify-bootstrap-pass-order-conflict",
                command=(
                    "cargo",
                    "test",
    ...
    ManualChapter(
        ...
        commands=(
            ...
            ManualCommand(
                label="audit-systems-profile-variants",
                command=(
                    "python3",
                    "scripts/run_v03_systems_profile_audit.py",
                    "--artifact-dir",
                    "/tmp/ail-manual-systems-profile-audit",
                ),
                evidence=(
    ...
    ManualChapter(
        ...
        commands=(
            ...
            ManualCommand(
                label="audit-rejected-repair-signal",
                command=(
                    "python3",
                    ...
                    "/tmp/ail-manual-repair-promotion",
                    "--artifact-dir",
                    "/tmp/ail-manual-rejected-repair-audit",
                ),
                evidence=(
